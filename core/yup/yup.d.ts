...
export interface StringSchemaConstructor {
  <T extends string | null | undefined = string>(): T extends string
    ? StringSchema<T>
    : StringSchema;
  new <T extends string | null | undefined = string>(): T extends string
    ? StringSchema<T>
    : StringSchema;
}
...
export interface StringSchema<T extends string | null | undefined = string>
  extends Schema<T> {
  customEmail(): StringSchema<T | undefined>;
  phone_ru(): StringSchema<T | undefined>;
  password(): StringSchema<T | undefined>;
  passwordEqual(ref: Ref): StringSchema<T | undefined>;
  personalInnRu(): StringSchema<T | undefined>;
  link(): StringSchema<T | undefined>;
}

export interface BooleanSchema<T extends boolean | null | undefined = boolean>
  extends Schema<T> {
  checkbox(): BooleanSchema<T | undefined>;
}

export interface ArraySchema<T> extends BasicArraySchema<T[]> {
  fileSize(size: number): ArraySchema<T>;
}

export interface MixedSchema<T = any> extends Schema<T> {
  ext(ext?: string[]): MixedSchema<T>;
  date(format: string): StringSchema<T | undefined>;
  fileSize(size: number, config?: any): MixedSchema<T>;
}
